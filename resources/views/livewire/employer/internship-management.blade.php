              ...
              <div class="swiper-wrapper">
                  <div class="swiper-slide">
                      <div class="std-dsb-card">
                          <p class="card-head">Total Interns</p>
                          <h1 class="card-body">14</h1>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      <div class="std-dsb-card">
                          <p class="card-head">Ongoing Internships</p>
                          <h1 class="card-body">104</h1>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      <div class="std-dsb-card">
                          <p class="card-head">Ended Internships</p>
             ...
             <div class="modal-content">
                  <div class="modal-body rounded">
                    ...
                    <div class="d-flex align-items-center flex-column gap-2">
                        <a href="/employer/internship-management-progress" class="new-discussion-btn w-100 text-center d-block">View</a>
