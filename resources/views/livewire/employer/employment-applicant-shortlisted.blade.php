              ...
              <div class="modal-body rounded">
                <div class="d-flex align-items-center justify-content-center mb-2 mt-3">
                  ...
                  <div class="text-center mb-3">
                    You have successfully selected <h6 class="d-inline">Mary Doe</h6> for the position of a <h6 class="d-inline">Junior Product Designer</h6>.
                  </div>
                    <a href="/employer/employment-applicant-contract" class="new-discussion-btn text-center d-block w-100 mb-2">Draft Contract</a>
         ...
         <div class="modal-content">
              <div class="modal-body rounded">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <button type="button" class="new-discussion-btn text-center mb-2">Schedule</button>
                </div>
              </div>
         </div>
    </div>
