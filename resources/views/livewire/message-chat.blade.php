         ...
         <div class="message-container">
              <div class="message-sidebar">
                   ...
                   <div class="message-sidebar-body">
                     @foreach ($studentsMessagesChain as $item)
                          <a href="/message-chat/{{base64_encode($item->proguide_id)}}">
                          <div class="contact active">
                               <div class="d-flex align-items-center justify-content-start gap-2">
                                    <div class="img">
                                        @if(empty($item->proguideChat->profile_image))
                                         <img src="{{asset('proguide-asset/asset/img/user-picture.png')}}" alt="">
                                        @else
                                          <img src="{{$item->proguideChat->profile_image}}" alt="">
                                        @endif
                                        </div>
                                    <h6>{{$item->proguideChat->full_name}}</h6>
                               </div>
              ...
              <div class="message-main">
                 @if(isset($userDetails))
                   ...
                   <div class="message-main-body" wire:poll.2s="showMessage({{base64_decode(Request::segment(2))}})">
