<div>
    <div class="main-content">
        ...
        <div class="row">
           <form action="" wire:submit.prevent="createFaq">
               <div class="row">
                   <div class="col-12 mb-4">
                       <div class="form-group">
                        <h5>Question</h5>
                           <input type="text" wire:model="question"  required class="form-control custom " placeholder="Type question here...">
                       </div>
                   </div>
                   <div class="col-12 mb-4">
                       <div class="form-group">
               ...
               <div class="d-flex align-items-center justify-content-between">
                   ...
                   <button type="submit" class="text-center new-discussion-btn px-sm-5" >
                        ...
                        <span wire:loading wire:target="createFaq" style="cursor: not-allowed">
                            Processing...
                        </span>
                   </button>
               </div>
