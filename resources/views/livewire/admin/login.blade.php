             ...
             <div class="row">
                  <div class="col-lg-6" data-aos="fade-left" wire:ignore.self>
                       <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 col-10 auth-form-container">
                                 <div class="auth-ctn">
                                      ...
                                      <form action="" class="auth-form" wire:submit.prevent="login">
                                           ...
                                           <p class="text-center auth-sub-heading mb-4">Sign in to your ProjKonnect <span class="fw-bold">Admin</span>
                                                account.</p>
                                                @if(session('error'))
                                           ...
                                           <div class="d-flex ckd-pswd align-items-center justify-content-between">
                                                ...
                                                <div>
                                                     <a class="forgot-text" href="forget-password">Forgot password?</a>
                                                </div>
                                           </div>
                                      ...
                                      <div style="padding: 30px; margin-bottom: 50px;" class="d-none">
                                           <fieldset>
